...
$(".console").click(function(e) {
    ...
    $.getJSON(self.attr("href"), function(data) {
        ...
        if (data.ok) {
            new simpleAlert({title: 'Console', content: '<a target="_blank" href="' + data.address + ':' + data.port + '/vnc.html?password=' + data.password + '">Please click here to open console page</a>'});
        } else {
